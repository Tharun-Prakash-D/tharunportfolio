...
xogame.addEventListener('click',()=>{
    console.log("Hi")
    window.location="https://tharun-prakash-d.github.io/xo/"
})
let cargame = document.getElementById('carredirect')
cargame.addEventListener('click',()=>{
    console.log("Hi")
    window.location="https://tharun-prakash-d.github.io/game/"
})
